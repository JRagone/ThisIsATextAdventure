...
class takeInput(object):
    ...
    def acceptInput(self,requestMessage):
        ...
        # self.e.focus_set()
        self.inputentry = Entry(self.root, bg = 'black', fg = '#00ff00', width = 60)
        self.inputentry.config(font='Courier', insertbackground = '#00ff00', highlightthickness = 0)
        self.inputentry.config(relief = 'flat', insertwidth = 5)
        ...
        print(self.position)
        self.inputentry.icursor(self.inputentry.index(INSERT))
